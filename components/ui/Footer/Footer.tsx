...
<footer className="bg-zinc-700 rounded-lg shadow dark:bg-gray-900 m-4">
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
            <a href="https://flashcardify.net/" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                <img src="/logo.png" className="h-8" alt="FlashCardify Logo" />
                <span className="text-gray-300  self-center text-2xl font-semibold whitespace-nowrap dark:text-white">FlashCardify</span>
            </a>
            <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-white-500 sm:mb-0 dark:text-white-400">
                <li>
                    <a href="/contact" className="text-gray-300 dark:text-white hover:underline">Contact</a>
                </li>
            </ul>
        </div>
