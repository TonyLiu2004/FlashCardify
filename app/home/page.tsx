...
const HomePage = () => {
  ...
  const [currentDeckVisibility, setCurrentDeckVisibility] =
        ...
        const fetchFeatureDeck = async () => {
          try {
            const response = await fetch(
              `/api/feature?user_id=${userData.id}`,
              {
                method: 'GET',
                headers: {
  ...
  return (
    <div className="min-h-screen bg-primaryBackground flex flex-col justify-center items-center p-4">
      <div className="flex flex-col lg:flex-row w-full max-w-7xl space-y-8 lg:space-y-0 lg:space-x-8">
        ...
        <div className="flex flex-col w-full lg:w-1/3 space-y-8">
          <div className="bg-white shadow-lg rounded-xl p-6">
            <h3 className="text-lg font-semibold text-center mb-6 text-black">
              Daily Streak
            </h3>
