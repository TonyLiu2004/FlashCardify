...
CREATE OR REPLACE TRIGGER "likes_delete_trigger" AFTER DELETE ON "public"."likes" FOR EACH ROW EXECUTE FUNCTION "public"."update_likes_count"();

CREATE OR REPLACE TRIGGER "likes_insert_trigger" AFTER INSERT ON "public"."likes" FOR EACH ROW EXECUTE FUNCTION "public"."update_likes_count"();
